...
import { ArrowUpRight, MapPin, Briefcase, ArrowRight } from 'lucide-react';
...
const JOBS = [
  ...
  { id: 'acquisition-specialist', title: 'Acquisition Specialist', dept: 'Sales Team', type: 'On-Site', location: 'Karachi', salary: 'PKR 80K–100K + Commission', tags: ['Sales'], description: 'Find the right clients, start the right conversations. You\'re the first impression Feature8 makes on the market.' },
  ...
  { id: 'devops-engineer', title: 'DevOps Engineer', dept: 'Tech', type: 'On-Site', location: 'Karachi', salary: null, salaryLabel: 'See Salary Pledge', tags: ['Tech'], description: 'Build and maintain the infrastructure that keeps everything running. CI/CD, cloud, reliability — this is your domain.' },
];
    ...
    <>
      <section className="section-pad" style={{ background: '#080808' }}>
        <div className="max-w-screen-xl mx-auto px-6 md:px-12">
          ...
          {/* Job listings — explicit Apply button */}
          ...
          {/* Hiring process — connected steps */}
          <motion.div initial={{ opacity: 0, y: 25 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.5 }}>
            <p className="label mb-6">How We Hire</p>
            <div className="relative grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {/* Connector line on desktop */}
              <div className="absolute top-8 left-[12.5%] right-[12.5%] h-px bg-gradient-to-r from-transparent via-rgba(184,242,36,0.2) to-transparent hidden md:block" style={{ background: 'linear-gradient(to right, transparent, rgba(184,242,36,0.2), transparent)' }} />
              {PROCESS.map((step, i) => (

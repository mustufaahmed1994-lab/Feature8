  ...
  return (
        <section className="section-pad" style={{ background: '#080808' }}>
                <div className="max-w-screen-xl mx-auto px-6 md:px-12">
                  ...
                  {/* Header */}
                        <motion.div
                                    ...
                                    className="mb-14"
                                  >
                                  <p className="label mb-3">Culture</p>p>
                        ...
                        <motion.div
                          ...
                          {PILLARS.map((p, i) => (
                                                <div key={i} className="card-dark p-5 text-center">
                                                              <p style={{ fontFamily: 'var(--font-jost)', fontSize: '0.6rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', marginBottom: '0.4rem' }}>{p.label}</p>p>
                                                              <p style={{ fontFamily: 'var(--font-jost)', fontWeight: 700, fontSize: '0.9rem', color: '#b8f224' }}>{p.value}</p>p>
                                                </div>div>
                                              ))}
                        </motion.div>motion.div>
                
                  {/* Square image pair — editorial break between pillars and values */}
          ...
          { label: 'The team.', delay: 0.12 },
                                                ...
                                                <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                                <div style={{ textAlign: 'center' }}>
                                                                                  <div style={{ width: 36, height: 36, borderRadius: '50%', border: '1px solid rgba(184,242,36,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 0.6rem' }}>
                                                                                                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(184,242,36,0.4)" strokeWidth="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="m21 15-5-5L5 21"/></svg>svg>
                                                                                    </div>div>
                                                                                  <p style={{ fontFamily: 'var(--font-jost)', fontSize: '0.55rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.15)' }}>Image</p>p>
                                                                </div>div>
                                                </div>div>
                                                <div style={{ position: 'absolute', bottom: '0.9rem', left: '1rem' }}>
                                                                <p style={{ fontFamily: 'var(--font-jost)', fontSize: '0.6rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)' }}>{img.label}</p>p>
                                                </div>div>
                                  </motion.div>motion.div>
                                ))}
                        </div>div>
                  ...
                  {/* Values grid */}
                      ...
                      return (
                                      <motion.div
                                                      ...
                                                      <div>
                                                                        <h3 style={{ fontFamily: 'var(--font-jost)', fontWeight: 700, fontSize: '0.9rem', color: 'white', marginBottom: '0.35rem' }}>{v.title}</h3>h3>
                                                                        <p style={{ fontFamily: 'var(--font-inter)', fontSize: '0.78rem', color: 'rgba(255,255,255,0.4)', lineHeight: 1.65 }}>{v.desc}</p>p>
                                                      </div>div>
                                      </motion.div>motion.div>
                                    );
        })}
                  ...
                  {/* Cinematic wide image — full-bleed strip between values and perks */}
                        <motion.div
                                    ref={stripRef}
                                  ...
                                  <div style={{ position: 'absolute', bottom: '1.25rem', left: '1.5rem', right: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                                              <p style={{ fontFamily: 'var(--font-jost)', fontSize: '0.62rem', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.25)' }}>Feature8 — Karachi</p>p>
                                              <p style={{ fontFamily: 'var(--font-jost)', fontSize: '0.58rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'rgba(184,242,36,0.35)' }}>Culture</p>p>
                                  </div>div>
                        </motion.div>motion.div>
                          ...
                          {PERKS.map((perk, i) => {
                                                ...
                                                return (
                                                                <div key={i} className="flex items-center gap-3">
                                                                                ...
                                                                                <span style={{ fontFamily: 'var(--font-inter)', fontSize: '0.82rem', color: 'rgba(255,255,255,0.6)' }}>{perk.text}</span>span>
                                                                </div>div>
                                                              );
                                  })}
                        </motion.div>motion.div>

  ...
  return (
    <section className="section-pad" style={{ background: '#0a0a0a', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
      <div className="max-w-screen-xl mx-auto px-6 md:px-12">
        ...
        {/* Services grid */}
        <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-16">
          {SERVICES.map((s, i) => {
            const Icon = s.icon;
            return (
        ...
        {/* Markets section — with intro context */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={gridInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.5 }}>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
            ...
            <p style={{ fontFamily: 'var(--font-inter)', fontSize: '0.85rem', color: 'rgba(255,255,255,0.35)', maxWidth: 360, lineHeight: 1.65 }}>
              We work across sectors. Our approach adapts to your context — the craft stays the same.
            </p>
          </div>
